...
{
    [Activity(Label = "Recibo valores vendedor")]
    public class ReciboValoresVendedorActivity : AppCompatActivity, IPermissionListener
    {
        private ResultadoDeOperacionGenerico<Vendedor> vendedor;
        public static string file_name = "OrderVendedor.pdf";
        ...
        public void OnPermissionGranted(PermissionGrantedResponse p0)
        {
            ...
            ticketPDF.AddFooterLine("                          COPIA VENDEDOR");
